...
class Router:
    ...
    def _get_internal_tool_schemas() -> list[dict]:
        ...
        return [
            ...
            {"name": "router__update_agent_phase", "description": "Update an agent's workflow phase.", "inputSchema": {"type": "object", "properties": {"agent_id": {"type": "string"}, "workflow_id": {"type": "string"}, "phase": {"type": "string"}}, "required": ["agent_id", "workflow_id", "phase"]}},
