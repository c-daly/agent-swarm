    ...
    if True:  # Always true - memory write always required
        return {
            ...
            "message": (
                ...
                "\n"
                "Tool: mcp__plugin_memory_memory__memory_write  (the memory plugin\n"
                "  is the single substrate; serena's write_memory is deprecated here).\n"
                "\n"
                "What to capture:\n"
                ...
                "      body='# Session Summary\\n\\n<what was done / decisions / gotchas>',\n"
                "  )\n"
                "============================================================"
            ),
        }
